...
var PBKDF2 = require("./sjcl").misc.pbkdf2;
...
if(process.argv[1] == __filename) {
	var t1=new Date();
    console.log('hashing...');
	var spass = scrypt('golden', "", 1024, 8, 8 ,32);
	console.log('Scrypt: '+(new Date()-t1)+' ms');
	console.log('Password encrypted '+new Buffer(spass, 'base64').toString('base64'));
}
